...
const scenarios: {
  ...
  },
  {
    ...
    expected: {
      totalRevenue: [{ sourceFieldNames: ['Total Revenue'], value: '$22,496M' }],
      earningsPerShare: [{ sourceFieldNames: ['Diluted EPS'], value: '$0.33' }],
      netIncome: [{ sourceFieldNames: ['Net Income'], value: '$1,172M' }],
      operatingIncome: [{ sourceFieldNames: ['Operating Income'], value: '$923M' }],
      grossMargin: [{ sourceFieldNames: ['Gross Margin'], value: '17.2%' }],
      operatingExpenses: [{ sourceFieldNames: ['Operating Expenses'], value: '$2,955M' }],
      buybacks: [{ sourceFieldNames: ['Share Buybacks'], value: '$0' }],
      dividends: [],
    },
  },
  {
    ...
    expected: {
      totalRevenue: [{ sourceFieldNames: ['Non-GAAP Total Revenue'], value: '$23,100M' }],
      earningsPerShare: [{ sourceFieldNames: ['Non-GAAP Diluted EPS'], value: '$0.40' }],
      netIncome: [{ sourceFieldNames: ['Non-GAAP Net Income'], value: '$1,393M' }],
      operatingIncome: [],
      grossMargin: [],
      operatingExpenses: [],
      buybacks: [],
  ...
  },
  {
    ...
    expected: {
      ...
      totalRevenue: [{ sourceFieldNames: ['Revenue', 'Rev', 'Gross Sales', 'Turnover'], value: '$22,496M' }],
      earningsPerShare: [],
      // Net Profit and Net Earnings have different values — kept as separate entries
      netIncome: [
        { sourceFieldNames: ['Net Profit'], value: '$1,172M' },
        { sourceFieldNames: ['Net Earnings'], value: '$1,393M' },
      ],
      operatingIncome: [],
      grossMargin: [],
      // Opex and Operating Costs have the same value — merged under first field name
      operatingExpenses: [{ sourceFieldNames: ['Opex', 'Operating Costs'], value: '$2,955M' }],
      buybacks: [],
      dividends: [],
    },
  },
  {
    ...
    expected: {
      totalRevenue: [{ sourceFieldNames: ['Revenue', 'Rev'], value: '$22.496B' }],
      earningsPerShare: [],
      netIncome: [{ sourceFieldNames: ['Net Profit', 'Net Earnings'], value: '$1,172 million' }],
      operatingIncome: [],
      grossMargin: [],
      operatingExpenses: [{ sourceFieldNames: ['Opex', 'Operating Costs'], value: '$2.955B' }],
      buybacks: [],
      dividends: [],
    },
  },
  {
    ...
    expected: {
      ...
      earningsPerShare: [],
      netIncome: [
        { sourceFieldNames: ['Net Profit'], value: '$2B' },
        { sourceFieldNames: ['Net Earnings'], value: '$2M' },
      ],
      operatingIncome: [],
      grossMargin: [],
      operatingExpenses: [],
  ...
  },
  {
    ...
    expected: {
      totalRevenue: [{ sourceFieldNames: ['Total Revenue'], value: '$2.1T' }],
      earningsPerShare: [{ sourceFieldNames: ['EPS'], value: '$1.96' }],
      netIncome: [{ sourceFieldNames: ['Net Income'], value: '$4.1B' }],
      operatingIncome: [],
      grossMargin: [],
      operatingExpenses: [{ sourceFieldNames: ['Operating Expenses'], value: '$850M' }],
      buybacks: [{ sourceFieldNames: ['Buybacks'], value: '$500K' }],
      dividends: [],
    },
  },
];

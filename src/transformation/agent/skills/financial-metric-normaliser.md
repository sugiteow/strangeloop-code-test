...
- If they have the same value, merge them into a single entry. Include all original source field names in the sourceMetricNames array, ordered by their appearance in the input.
